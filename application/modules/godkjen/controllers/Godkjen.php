    ...
    function generate_payment_file()
    {
        ...
        foreach($trans as $key => $value)
        {
            ...
            if($currency=="NOK" || $currency=="kr"){
                ...
                $txt.='"CMUONO","'.$insurer_acc_no.'","'.$acc_no.'","'.$currency.'","'.$amount.'","NOK","","1","'.$name.'","'.$address.'","'.$code.'","'.$place.'","","","","","1","Money Transferred through AGS - '.$client_message.'","","","","'.$ags_message.'","","","","","","","","","","","","","","","","","'.$t_id.'","","","","","","","","","","","","DABADKKK","","","DK",';
            }
            $txt.="\n";
