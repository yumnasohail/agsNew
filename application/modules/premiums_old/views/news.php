                        ...
                        <?php } ?>
                                <div class="col-sm-12" data-id="<?php echo $value['id'] ?>" data_f_id="<?php echo $value['f_id'] ?>">
                                    <div class=" bg-theme-1   space_set">
                                        <?php echo date("m.d.Y", strtotime($value['start_date']))."   -   ".date("m.d.Y", strtotime($value['end_date'])); ?>
                                        ...
                                        <div class=" row col-sm-12">
                                            ...
                                            <label>Dato betaling videresendt</label>
                                                <div class="input-group date">
                                                    <input type="text" class="form-control" name="dato"  id="dato" value="<?php  echo  date("d-F-yy", strtotime($pm['dato'])) ?>">
