        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <a class="btn btn-sm btn-outline-primary ml-3 d-none d-md-inline-block btn-right" href="<?php echo ADMIN_BASE_URL . 'news/create'; ?>">&nbsp;&nbsp;&nbsp; + Add</a>
                                ...
                                <tbody>
                                        ...
                                        if (isset($news)) {
                                            foreach ($news->result() as
                                                ...
                                                echo anchor($edit_url, '<i class="iconsminds-file-edit"></i>', array('class' => 'action_edit  blue c-btn','title' => 'Edit news'));

                                                echo anchor('"javascript:;"', '<i class="iconsminds-close"></i>', array('class' => 'delete_record  red c-btn', 'rel' => $new->id, 'title' => 'Delete news'));
                                                ?>
                                                </td>
                                            </tr>
                                            <?php } ?>    
...
$(document).ready(function(){
    ...
    /*//////////////////////// code for detail //////////////////////////*/
            ...
            //alert(id); return false;
              $.ajax({
                    type: 'post',
                    url: "<?php echo ADMIN_BASE_URL?>news/detail",
                    data: {'id': id},
                    async: false,
    ...
    /*///////////////////////// end for code detail //////////////////////////////*/
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
                ...
                e.preventDefault();
              swal({
                title : "Are you sure to delete the selected news?",
