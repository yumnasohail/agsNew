  ...
  <div class="container-fluid">
      <div class="row">
          <div class="col-12">
              ...
              <a class="btn btn-sm btn-outline-primary ml-3 d-none d-md-inline-block btn-right" href="<?php echo ADMIN_BASE_URL . 'coverage_category'; ?>">&nbsp;&nbsp;&nbsp;Back</a> 
        ...
        <div class="col-md-12 col-lg-12 col-12 mb-4">
            ...
            <div class="card-body">
                ...
                if (isset($hidden) && !empty($hidden))
                    echo form_open_multipart(ADMIN_BASE_URL . 'coverage_category/submit/' . $update_id, $attributes, $hidden);
                else
                    echo form_open_multipart(ADMIN_BASE_URL . 'coverage_category/submit/' . $update_id, $attributes);
                ?>
