 ...
 <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1 class="color-theme-1">Dekningskategori</h1>
                    <a class="btn btn-sm btn-outline-primary ml-3 d-none d-md-inline-block btn-right" href="<?php echo ADMIN_BASE_URL . 'coverage_category/create'; ?>">&nbsp;&nbsp;&nbsp; + Add</a>
                                ...
                                <tbody>
                                        ...
                                        if (isset($news)) {
                                            foreach ($news->result() as
                                                    $new) {
                                                $i++;
                                                $set_publish_url = ADMIN_BASE_URL . 'coverage_category/set_publish/' . $new->id;
                                                $set_unpublish_url = ADMIN_BASE_URL . 'coverage_category/set_unpublish/' . $new->id ;
                                                $edit_url = ADMIN_BASE_URL . 'coverage_category/create/'. $new->id ;
                                                $delete_url = ADMIN_BASE_URL . 'coverage_category/delete/' . $new->id;
                                                ?>
...
$(document).ready(function(){
    ...
    /*//////////////////////// code for detail //////////////////////////*/
            ...
            //alert(id); return false;
              $.ajax({
                    type: 'post',
                    url: "<?php echo ADMIN_BASE_URL?>coverage_category/get_claim_detail",
                    data: {'id': id},
                    async: false,
    ...
    /*///////////////////////// end for code detail //////////////////////////////*/
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
                ...
                e.preventDefault();
              swal({
                title : "Are you sure to delete the selected coverage_category?",
                text : "You will not be able to recover this coverage_category!",
                type : "warning",
                ...
                function () {
                       ...
                       $.ajax({
                            type: 'post',
                            url: "<?php echo ADMIN_BASE_URL?>coverage_category/delete",
                            data: {'id': id},
                            async: false,
                            success: function() {
                            location.reload();
                ...
                swal("Deleted!", "coverage_category has been deleted.", "success");
              });
    ...
    /*///////////////////////////////// START STATUS  ///////////////////////////////////*/
        ...
        $(document).off("click",".action_publish").on("click",".action_publish", function(event) {
            ...
            var status = $(this).attr('status');
             $.ajax({
                type: 'post',
                url: "<?= ADMIN_BASE_URL ?>coverage_category/change_status",
