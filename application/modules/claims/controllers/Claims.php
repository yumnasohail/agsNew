...
Modules::run('site_security/has_permission');
   ...
   function process_claim()
    ...
    function manage() {
        ...
        $incident_date= date('Y-m-d', strtotime($data['news']->damage_date));
        $where=array("policies.del_status"=>"0","policy_period.del_status"=>"0","policies.f_id"=>$data['news']->federation,"policy_period.start_date <= "=>$incident_date,"policy_period.end_date >= "=>$incident_date);
