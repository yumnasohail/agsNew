 ...
 <input type="hidden" id="customerSearchField" value="<?=(isset($searchId) && !empty($searchId) ? $searchId : '')?>" />
 <main>
...
$(document).ready(function(){
    ...
    /*///////////////////////// end for code detail //////////////////////////////*/
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
                ...
                var id = $(this).attr('rel');
                e.preventDefault();
            var check_trans=true;
             $.ajax({
                    type: 'post',
                    url: "<?php echo ADMIN_BASE_URL?>claims/payment_check",
                    data: {'id': id},
                    async: false,
                    success: function(test_body) {
                    var res = test_body;
            ...
            if(check_trans){
              swal({
                ...
                swal("Can't be deleted", "There is a payment generated against this claim", "error");
                return false;
            }
...
$(document).ready(function() {
     ...
     $('#claimDataTable_filter').find(':input').keyup(function () {
    console.log('helloeeee');
    });

    $('#claimDataTable_filter').find(':input').keyup();
</script>
