...
<form action="<?php echo ADMIN_BASE_URL.'claims/edit_form'; ?>" method="post" id="claim_form"> 
    ...
    <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
        ...
        <input type="text" class="form-control" name="a_sportsno"
            id="a_birthValidation"  required value="<?php echo $new->a_sportsno; ?>">
    </div>
    <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
    ...
    <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
        ...
        <div class="input-group mb-3">
            <select class="custom-select" id="inputGroupSelect02" name="insurance_under">
                <option value="Standard forsikring" <?php if($new->insurance_under=="Standard forsikring") echo "selected"; ?>>Standard forsikring </option>
                <option value="Utvidet forsikring" <?php if($new->insurance_under=="Utvidet forsikring") echo "selected"; ?>>Utvidet forsikring </option>
            </select>
            <div class="input-group-append">
                <label class="input-group-text" for="inputGroupSelect02">Options</label>
            </div>
