...
<table class=" table table-bordered border-theme1">
    ...
    <tr>
        <td>Leggbeskyttere benyttet</td>
        <td><?php echo $new->leg_protector_used; ?></td>
    </tr>
...
<form action="<?php echo ADMIN_BASE_URL.'claims/edit_form'; ?>" method="post" id="claim_form"> 
    ...
    <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
        ...
        <div class="input-group mb-3">
            <select class="custom-select" id="inputGroupSelect02" name="leg_protector_used">
                <option value="Ja" <?php if($new->leg_protector_used=="Ja") echo "selected"; ?>>Ja</option>
                <option value="Nei"  <?php if($new->leg_protector_used=="Nei") echo "selected"; ?>>Nei</option>
            </select>
            <div class="input-group-append">
                <label class="input-group-text" for="inputGroupSelect02">Options</label>
            </div>
