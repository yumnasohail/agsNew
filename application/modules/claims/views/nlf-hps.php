...
<table class=" table table-bordered border-theme1">
    ...
    <tr>
        <td>Er hendelsesforløpet sendt til NLF/HPS?</td>
        <td><?php echo $new->sento_nlf_hps; ?></td>
    </tr>
    <tr>
        <td>Dato</td>
...
<form action="<?php echo ADMIN_BASE_URL.'claims/edit_form'; ?>" method="post" id="claim_form"> 
    ...
    <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
        ...
        <div class="input-group mb-3">
            <select class="custom-select" id="inputGroupSelect02" name="sento_nlf_hps">
                <option value="Ja" <?php if($new->sento_nlf_hps=="Ja") echo "selected"; ?>>Ja</option>
                <option value="Nei" <?php if($new->sento_nlf_hps=="Nei") echo "selected"; ?>>Nei</option>
            </select>
    ...
    <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
        ...
        <div class="input-group mb-3">
            <select class="custom-select" id="inputGroupSelect02" name="insurance_under">
                ...
                <option value="Utvidet ved invaliditet" <?php if($new->insurance_under=="Utvidet ved invaliditet") echo "selected"; ?>>Utvidet ved invaliditet </option>
                <option value="Utvidet ved dødsfall" <?php if($new->insurance_under=="Utvidet ved dødsfall") echo "selected"; ?>>Utvidet ved dødsfall </option>
                <option value="IndividuUtvidet ved invaliditet og dødsfall" <?php if($new->insurance_under=="Utvidet ved invaliditet og dødsfall") echo "selected"; ?>>Utvidet ved invaliditet og dødsfall</option>
                <option value="Tandempassasjer uten medlemsskap" <?php if($new->insurance_under=="Tandempassasjer uten medlemsskap") echo "selected"; ?>>Tandempassasjer uten medlemsskap </option>
            </select>
            <div class="input-group-append">
                <label class="input-group-text" for="inputGroupSelect02">Options</label>
            </div>
