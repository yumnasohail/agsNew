        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-content" style="text-align:center;">
                    <h2 class="breadcrumb__title"><?= $this->lang->line('text_cyber_title'); ?></h2>
                    <p><?= $this->lang->line('text_cyber_sub_heading'); ?></p>
                ...
                <div class="blog-post-item">
                    <div class="blog-post-img single-case-slider">
                        <div class="single-case-item">
                            <a >
                                <img src="<?php echo STATIC_FRONT_IMAGE.'cyber1.jpeg' ?>" alt="blog image" class="blog__img">
                            </a>
                        </div>
                    </div><!-- end blog-post-img -->
                    <div class="blog-post-body">
<p class="blog__desc">
<?= $this->lang->line('text_cyber_line1'); ?>  </p>                      
