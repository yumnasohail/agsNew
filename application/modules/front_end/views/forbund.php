        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-content" style="text-align:center;">
                    <h2 class="breadcrumb__title"><?= $this->lang->line('text_forbund_title'); ?> </h2>
                    <p><?= $this->lang->line('text_forbund_sub_heading'); ?></p>
            ...
            <div class="col-lg-4">
                ...
                <div class="sidebar mt-0">
                    <div class="sidebar-widget contact-widget">
                        ...
                        <p><?= $this->lang->line('text_forbund_info'); ?></p>
                        <ul class="contact__links">
                            <li>
                                <i class="fa fa-user"></i>
                                Lars-Petter Myklebost<br><?= $this->lang->line('text_daglig'); ?>
                            </li>
                            <li>
            ...
            <div class="col-lg-8">
                <div class="blog-post-item">
                    ...
                    <div class="blog-post-body">
                        <p class="blog__desc">
                        <?= $this->lang->line('text_forbund_line1'); ?></p>
