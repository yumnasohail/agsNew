                    ...
                    <div class="card mb-4">
                        <div id="smartWizardValidation">
                            <ul class="card-header">
                                <li><a href="#step-0">Step 1<br /><small>Informasjon om utøveren</small></a></li>
                                <li><a href="#step-1">Step 2<br /><small>Informasjon om skaden</small></a></li>
                                <li><a href="#step-2">Step 3<br /><small>Informasjon om utbetaling og forsikring</small></a></li>
                                <li><a href="#step-3">Step 4<br /><small>Verifisering</small></a></li>
                                <li><a href="#step-4">Step 5<br /><small>Samtykke</small></a></li>
                            ...
                            <div class="card-body">
                                <div id="step-0">
                                    ...
                                    <div class="partner-image">
                                            <img src="<?php echo STATIC_FRONT_IMAGE.'top_logo_sl.png'; ?>">
                                        </div>
                                        <div class="row">
                                ...
                                <div id="step-1">
                                     <form  id="form-step-1" class="tooltip-label-right" novalidate>
                                        <div class="row">
                                            ...
                                            <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                                <label for="name">Idrett</label>
                                                <input type="text" class="form-control" name="sport"
                                                    id="inputGroupSelect02"  required <?php  if(isset($new->sport) && !empty($new->sport))  echo $new->sport; ?>>
                                            </div>
                                             <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                ...
                                <div id="step-3" >
                                      <form id="form-step-3" class="tooltip-label-right" onsubmit="validateCaptcha()" >
                                        <div id="captcha">
                                        </div>
                                        <div class="row">
    ...
    $.validator.addMethod("noSpaces", function(value, element) {
       ...
       var code;
        ...
        $('.finish-btn').off('click').click(function(e){
			e.preventDefault();
            var form_data=$('#form-step-0, #form-step-1, #form-step-2, #form-step-3, #form-step-4').serialize();
            $.ajax({
					type: 'POST',
