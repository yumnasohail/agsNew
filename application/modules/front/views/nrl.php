                    ...
                    <div class="card mb-4">
                        <div id="smartWizardValidation">
                                             ...
                                             <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select class="custom-select" id="inputGroupSelect02" name="place_of_damage" required>
                                                        <option value="">Select</option>
                                                        <option value="I kamp" <?php if(isset($new->place_of_damage) && !empty($new->place_of_damage) && $new->place_of_damage=="I kamp") echo "selected"; ?>>I kamp</option>
                                             ...
                                             <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select class="custom-select" id="inputGroupSelect02" name="basis" required>
                                                        <option value="">Select</option>
                                                        <option value="Gress" <?php if(isset($new->basis) && !empty($new->basis) && $new->basis=="Gress") echo "selected"; ?>>Gress </option>
                                                        <option value="Kunstdekke" <?php if(isset($new->basis) && !empty($new->basis) && $new->basis=="Kunstdekke") echo "selected"; ?>>Kunstdekke </option>
                                                        <option value="Snø/is" <?php if(isset($new->basis) && !empty($new->basis) && $new->basis=="Snø/is") echo "selected"; ?>>Snø/is </option>
                                                        <option value="Grus" <?php if(isset($new->basis) && !empty($new->basis) && $new->basis=="Grus ") echo "selected"; ?>>Grus  </option>
                                                        <option value="Innendørs" <?php if(isset($new->basis) && !empty($new->basis) && $new->basis=="Innendørs ") echo "selected"; ?>>Innendørs  </option>
                                                        <option value="Annet" <?php if(isset($new->basis) && !empty($new->basis) && $new->basis=="Annet") echo "selected"; ?>>Annet  </option>
                                                    </select>
                                                    <div class="input-group-append">
                                                        <label class="input-group-text" for="inputGroupSelect02">Options</label>
                                                    </div>
                                             ...
                                             <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select class="custom-select" id="inputGroupSelect02" name="match_with" required>
                                                        <option value="">Select</option>
                                                        <option value="Egen aldersklasse" <?php if(isset($new->match_with) && !empty($new->match_with) && $new->match_with=="Egen aldersklasse") echo "selected"; ?>>Egen aldersklasse</option>
                                                        <option value="Seniorklassen" <?php if(isset($new->match_with) && !empty($new->match_with) && $new->match_with=="Seniorklassen") echo "selected"; ?>>Seniorklassen</option>
                                                    </select>
                                                    <div class="input-group-append">
                                                        <label class="input-group-text" for="inputGroupSelect02">Options</label>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <option value="">Select</option>
                                                        <option value="Individuell" <?php if(isset($new->insurance_under) && !empty($new->insurance_under) && $new->insurance_under=="Individuell") echo "selected"; ?>>Individuell </option>
                                                        <option value="Individuell utvidet" <?php if(isset($new->insurance_under) && !empty($new->insurance_under) && $new->insurance_under=="Individuell utvidet") echo "selected"; ?>>Individuell utvidet </option>
                                                        <option value="Landslag" <?php if(isset($new->insurance_under) && !empty($new->insurance_under) && $new->insurance_under=="Landslag") echo "selected"; ?>>Landslag </option>
                                                    </select>
                                                    <div class="input-group-append">
                                                        <label class="input-group-text" for="inputGroupSelect02">Options</label>
                                                    </div>
                                                ...
                                                <div class="mb-4">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="customRadio1" name="permission"
                                                            class="custom-control-input" value="Ja" <?php if(!isset($new->permission)) echo "checked"; ?>  required  <?php if(isset($new->permission) && !empty($new->permission) && $new->permission=="Ja") echo "checked"; ?>>
                                                        <label class="custom-control-label" for="customRadio1">Ja </label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="customRadio2" name="permission"
                                                            class="custom-control-input"  value="Nei" <?php if(isset($new->permission) && !empty($new->permission) && $new->permission=="Nei") echo "checked"; ?>>
                                                ...
                                                <div class="mb-4">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="customRadio3" name="self"
                                                            class="custom-control-input" value="Jai" <?php if(!isset($new->self)) echo "checked"; ?>  <?php if(isset($new->self) && !empty($new->self) && $new->self=="Jai") echo "checked"; ?>>
                            ...
                            <div class="btn-toolbar custom-toolbar text-center card-body pt-0">
                                ...
                                <button class="btn btn-secondary next-btn" id="nxt-btn" type="button">Next</button>
