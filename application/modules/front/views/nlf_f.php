                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="a_sportsno"
                                                    id="a_sportsno"  required value="<?php if(isset($new->a_sportsno) && !empty($new->a_sportsno)) echo $new->a_sportsno; ?>">
                                            </div>
                                            <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group position-relative error-l-100 col-sm-12 col-xs-12 col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="jumping_feild"
                                                    id="jumpValidation"  required value="<?php  if(isset($new->jumping_feild) && !empty($new->jumping_feild))  echo $new->jumping_feild; ?>">
                                            </div>
                                            <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                                <label>Dato</label>
                                                <div class="input-group date">
                                                    <input type="text" class="form-control" name="damage_date" value="<?php  if(isset($new->damage_date) && !empty($new->damage_date))  echo $new->damage_date; ?>">
                                            ...
                                            <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                                ...
                                                <div class="input-group datetimepicker1">
                                                    <input type="text" class="form-control" name="damage_time" value="<?php  if(isset($new->damage_time) && !empty($new->damage_time))  echo $new->damage_time; ?>">
                                                    <span class="input-group-text input-group-append input-group-addon">
                                                        <i class="simple-icon-calendar"></i>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select class="custom-select" id="inputGroupSelect02" name="insurance_under" required>
                                                        <option value="">Select</option>
                                                        <option value="Tandem" <?php if(isset($new->insurance_under) && !empty($new->insurance_under) && $new->insurance_under=="Tandem") echo "selected"; ?>>Tandem</option>
                                                        ...
                                                        <option value="Ekstra" <?php if(isset($new->insurance_under) && !empty($new->insurance_under) && $new->insurance_under=="Ekstra") echo "selected"; ?>>Ekstra </option>
                                                        <option value="Basis utvidet"  <?php if(isset($new->insurance_under) && !empty($new->insurance_under) && $new->insurance_under=="Basis utvidet") echo "selected"; ?>>Basis utvidet</option>
                                                        <option value="Ekstra utvidet"  <?php if(isset($new->insurance_under) && !empty($new->insurance_under) && $new->insurance_under=="Ekstra utvidet") echo "selected"; ?>>Ekstra utvidet </option>
                                                    </select>
                                            ...
                                            <div class="col-sm-12 col-xs-12 col-md-6">
                                                ...
                                                <div class="mb-4">
                                                    <div class="custom-control custom-radio">
                                                        ...
                                                        <label class="custom-control-label" for="customRadio1" checked>Ja </label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
