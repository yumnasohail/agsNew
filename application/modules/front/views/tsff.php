                    ...
                    <div class="card mb-4">
                        <div id="smartWizardValidation">
                            <ul class="card-header">
                                ...
                                <li><a href="#step-1">Step 2<br /><small>Informasjon om spilleren</small></a></li>
                                ...
                                <div id="step-0"  >
                                    <form id="form-step-0" class="tooltip-label-right" novalidate>
                                        <div class="partner-image">
                                            <img src="<?php echo STATIC_FRONT_IMAGE.'top_logo_tsff.png'; ?>">
                                        </div>
                                        <div class="row">
                                     ...
                                     <form  id="form-step-2" class="tooltip-label-right" novalidate>
                                        <div class="row">
                                            ...
                                            <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                             ...
                                             <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                                 <label for="lastName">Leggbeskyttere benyttet</label>
                                                <div class="input-group mb-3">
                                                    <select class="custom-select" id="inputGroupSelect02" name="leg_protector_used" required>
                                                        <option value="">Select</option>
                                                        <option value="Ja" <?php if(isset($new->leg_protector_used) && !empty($new->leg_protector_used) && $new->leg_protector_used=="Ja") echo "selected"; ?>>Ja</option>
                                                        <option value="Nei" <?php if(isset($new->leg_protector_used) && !empty($new->leg_protector_used) && $new->leg_protector_used=="Nei") echo "selected"; ?>>Nei</option>
                                                    </select>
                                                    <div class="input-group-append">
                                                        <label class="input-group-text" for="inputGroupSelect02">Options</label>
                                                    </div>
