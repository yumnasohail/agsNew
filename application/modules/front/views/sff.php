                                ...
                                <div id="step-0"  >
                                    <form id="form-step-0" class="tooltip-label-right" novalidate notvalidate>
                                        <div class="partner-image">
                                            <img src="<?php echo STATIC_FRONT_IMAGE.'logo_ssf.png'; ?>">
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12 col-md-12">
                                                <p><i class="iconsminds-right-2"></i>
                                                    Alla anspråk måste rapporteras via detta anspråksformulär innan betalningen kan göras.
                                                </p>
                                                <p><i class="iconsminds-right-2"></i>Ansökningsformuläret måste fyllas i av skadelidande, någon som agerar för skadelidande (efter att ha fått nödvändigt samtycke till det) eller har föräldraansvar gentemot skadelidande - i förekommande fall.                                                </p>
                                            </div>
