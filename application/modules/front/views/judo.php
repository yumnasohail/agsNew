                                ...
                                <div id="step-0"  >
                                    <form id="form-step-0" class="tooltip-label-right" novalidate>
                                        <div class="partner-image">
                                            <img src="<?php echo STATIC_FRONT_IMAGE.'top_banner_1.jpg'; ?>">
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12 col-md-12">
                                                <p><i class="iconsminds-right-2"></i>
                                                Alle skader må være innrapportert via dette skadeskjema, før skadeutbetaling kan utføres.</p>
                                                <p><i class="iconsminds-right-2"></i>
                                                Skadeskjemaet må fylles ut av skadelidte, noen som handler på skadelidtes vegne (etter å ha innhentet nødvendig samtykke til det) eller har foreldreansvaret overfor skadelidte - når aktuelt.                                                </p>
                                            </div>
                                             ...
                                             <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select class="custom-select" id="inputGroupSelect02" name="place_of_damage" required>
                                                        <option value="">Select</option>
                                                        <option value="I kamp" <?php if(isset($new->sport) && !empty($new->sport) && $new->sport=="I kamp") echo "selected"; ?>>I kamp</option>
                                                        <option value="Under trening" <?php if(isset($new->sport) && !empty($new->sport) && $new->sport=="Under trening") echo "selected"; ?>>Under trening</option>
                                                        <option value="Annet" <?php if(isset($new->sport) && !empty($new->sport) && $new->sport=="Annet") echo "selected"; ?>>Annet</option>
                                                    </select>
                                            ...
                                            <div class="form-group position-relative error-l-75 col-sm-12 col-xs-12 col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select class="custom-select" id="inputGroupSelect02" name="insurance_under" required>
                                                        <option value="">Select</option>
                                                        <option value="Standard forsikring" <?php if(isset($new->insurance_under) && !empty($new->insurance_under) && $new->insurance_under=="Standard forsikring") echo "selected"; ?>>Standard forsikring</option>
                                                        <option value="Utvidet forsikring" <?php if(isset($new->insurance_under) && !empty($new->insurance_under) && $new->insurance_under=="Utvidet forsikring") echo "selected"; ?>>Utvidet forsikring </option>
                                                    </select>
                                                    <div class="input-group-append">
                                                        <label class="input-group-text" for="inputGroupSelect02">Options</label>
                                                    </div>
